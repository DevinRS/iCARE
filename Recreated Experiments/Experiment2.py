...
starting_features = ['Age', 'Gender', 'Obesity', 'Alopecia', 'muscle stiffness', 'visual blurring', 'weakness', 'delayed healing', 'sudden weight loss', 'Polyphagia', 'Genital thrush', 'partial paresis', 'Irritability', 'Itching', 'Polyuria', 'Polydipsia']
...
plt.savefig('ExperimentResult/Experiment2_AccAucGraph.png')
